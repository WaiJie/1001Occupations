...
from app.components.occupation_view import show_occupation_dialog
...
if "occupation" in params:
    try:
        st.session_state.dialog_code = int(params["occupation"])
...
if st.session_state.get("dialog_open") and st.session_state.get("dialog_code") is not None:
    show_occupation_dialog(st.session_state.dialog_code)
